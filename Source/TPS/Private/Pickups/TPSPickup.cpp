...
bool ATPSPickup::GivePickupTo(APawn* PlayerPawn)
{
	return false;
}

void ATPSPickup::PickupWasTaken()
{
	...
	GetWorldTimerManager().SetTimer(RespawnTimerHandle, this, &ATPSPickup::Respawn, RespawnTime);
}
...
void ATPSPickup::GenerateRotationYaw()
{
	const auto Direction = FMath::RandBool() ? 1.0f : -1.0f;
	RotationYaw = FMath::RandRange(1.0f, 2.0f) * Direction;
}

bool ATPSPickup::CouldBeTaken() const
{
